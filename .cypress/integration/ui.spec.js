...
describe('Test table display', () => {
  ...
  it('Test nested fields display', () => {
    ...
    // Wait for the button to become clickable before clicking it
    cy.get('button.euiLink').eq(2).should('be.visible').click({ force: true });
  
    // Wait for the content with the text 'message' to appear
